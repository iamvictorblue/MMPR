      ...
      <div className="relative isolate bg-white">
        ...
        <main className="container mx-auto px-4 py-16">
          ...
          <div className="mb-16 text-center">
            ...
            {/* Plena Gallery Images */}
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 justify-center">
              <Image
                src="/images/PLENA/PLENA P.jpg"
                alt="Manuel Jiménez 'Canario'"
                width={180}
                height={180}
                className="rounded-lg shadow-lg object-cover w-full h-auto"
              />
              <Image
                src="/images/PLENA/PLENA L.jpg"
                alt="Gumersindo 'Sindo' Mangual"
                width={180}
                height={180}
                className="rounded-lg shadow-lg object-cover w-full h-auto"
              />
              <Image
                src="/images/PLENA/PLENA E.jpg"
                alt="Efraín 'Mon' Rivera"
                width={180}
                height={180}
                className="rounded-lg shadow-lg object-cover w-full h-auto"
              />
              <Image
                src="/images/PLENA/PLENA N.jpg"
                alt="Marcial Reyes"
                width={180}
                height={180}
                className="rounded-lg shadow-lg object-cover w-full h-auto"
