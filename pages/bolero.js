                ...
                <div className="flex-1 space-y-6 text-lg text-gray-700 leading-relaxed">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <blockquote className="italic text-lg text-bolero-700 border-l-4 border-bolero-600 pl-4">
                      "Daniel Santos dejó grabados unos 308 discos de larga duración. Un verdadero récord, y quizás sea el cantante que más discos dejó grabados en la historia de la canción popular latinoamericana".
                    </blockquote>
